    ...
    return (
        <div className="container mt-3 mb-3 shadow-lg p-2 bg-body rounded">
            <Row className="text-center text-danger mb-3">
                <h2><span className="border-bottom border-2 border-danger">List Of All Available Orders</span></h2>
            </Row>
                        ...
                        >
                            ...
                            <td>
                                ...
                                <button disabled={order.status === 'Accepted' ? true : false}
                                    onClick={() => { onAcceptOrder(order._id) }} className='btn btn-sm btn-outline-success ms-2'>
                                    Accept
                                </button>
                            </td>
                        </tr>)
